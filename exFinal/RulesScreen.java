...
public class RulesScreen extends Screen {
    ...
    public RulesScreen(ScreenManager screenManager) {
        ...
        String text1 = "<html><b>Welcome to Rush Hour!</b><br><br>" +
                       "<b>Objective:</b><br>" +
        ...
        String text2 = "<html><b>How to Play:</b><br>" +
                       "1. Use the mouse to select and drag the vehicles.<br>" +
        ...
        label1.setBounds(50, 20, 500, 100);

        label2.setFont(new Font("Serif", Font.PLAIN, 18));
        label2.setBounds(50, 130, 500, 150);

        label3.setFont(new Font("Serif", Font.PLAIN, 18));
        label3.setBounds(50, 290, 500, 150);
